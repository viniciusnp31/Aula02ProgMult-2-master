...
package br.usjt.aula02final.util;
...
public class Utils {
    ...
    private static br.usjt.aula02final.util.StatusTracker mStatusTracker = br.usjt.aula02final.util.StatusTracker.getInstance();
